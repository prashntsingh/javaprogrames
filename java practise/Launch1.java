...
{ 
	...
	public Constructor(String name,String breed,int cost)/* to avoid shadowing i.e same name of instance and local variable we are using "this" keyword if we dont use it then output will be null */
